...
class ObjScnearioActs:
    ...
    def __call__(self, all_target_events,target_name):
        ...
        self.check_api_dispatch_function(all_target_events,target_name)
    ...
    def check_api_dispatch_function(self, all_target_events,target_name):
        print("enter loop all target",all_target_events)
        print("check disp",target_name)
                    ...
                    if target_name == tar_name:
                        ...
                        if action:
                            ...
                            # Dispatch the action if it's found
                                self.register_dispatch.dispatch(action, all_target_events,target_name)
                            except KeyError:
    ...
    def initial_acceleration_acts(self, all_target_events,target_name):
        self.Obj_algo_acts.Obj_Accelration_act(all_target_events,target_name)

    def obj_changelane(self,all_target_events,target_name):
        self.Obj_algo_acts.obj_changelane(all_target_events,target_name)

    def obj_setlateraldisplacement(self, all_target_events,target_name):
        self.Obj_algo_acts.obj_setlateraldisplacement(all_target_events,target_name)

    def obj_setlongitudinalspeed(self,all_target_events,target_name):
        self.Obj_algo_acts.obj_set_longitudinal_speed(all_target_events,target_name)